module.exports = {
  ...
  messages: {
    ...
    'app.header.menu.front': '前端',
    'app.header.menu.service': '后端',
    'app.header.menu.framework': '架构',
    'app.header.menu.bigData': '大数据',
    'app.header.menu.feedback': '反馈',
    'app.header.lang': 'English',
    'app.content.edit-page': '在 GitHub 上编辑此页！',
    'app.content.edit-demo': '在 GitHub 上编辑此示例！',
    'app.page.feature1.title': '简洁至上',
    'app.page.feature2.title': '易学易用',
    'app.page.feature3.title': '高性能',
    'app.page.feature1.description':
      '以 Ant Design 为基础组件实现，增加了自定义的通用或业务控制属性，保持业务开发的通用性。',
    'app.page.feature2.description':
      '享受 React前端组件库 的开发体验，在 Markdown 中使用 React 组件，同时可以使用 React 来开发自定义主题业务。',
    'app.page.feature3.description':
      'SipPress 为每个页面预渲染生成静态的 HTML，同时在页面被加载的时候，将作为 SPA 方式运行实现。',
    ...
    'app.home.title': '虹信软件 研发知识库',
    'app.home.slogan': '前端基于Ant Design为基础组件实现通用组件开发',
    'app.home.introduce':
