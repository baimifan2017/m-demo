module.exports = {
  ...
  messages: {
    ...
    'app.header.menu.front': 'Front',
    'app.header.menu.service': 'Service',
    'app.header.menu.framework': 'Framework',
    'app.header.menu.bigData': 'BigData',
    'app.header.menu.feedback': 'Feedback',
    'app.header.lang': '中文',
    ...
    'app.home.title': 'RainbowSoft Library',
    'app.home.slogan': "Based on the world's second most popular React UI framework",
    'app.home.introduce':
