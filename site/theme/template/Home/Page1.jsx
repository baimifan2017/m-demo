    ...
    return (
      <div className="home-page-wrapper page1">
        <div className="feature">
          <h2>
            <FormattedMessage id="app.page.feature1.title" />
          </h2>
          <p>
            <FormattedMessage id="app.page.feature1.description" />
          </p>
        </div>
        <div className="feature">
          <h2>
            <FormattedMessage id="app.page.feature2.title" />
          </h2>
          <p>
            <FormattedMessage id="app.page.feature2.description" />
          </p>
        </div>
        <div className="feature">
          <h2>
            <FormattedMessage id="app.page.feature3.title" />
          </h2>
          <p>
            <FormattedMessage id="app.page.feature3.description" />
          </p>
        </div>
      </div>
    );
